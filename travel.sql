...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 23 2024 г., 21:43
...
(2, '(Администратор)К теме выше', '(ಥ﹏ಥ)');
...
(4, 'Санкт-Петербург', 'Вы познакомитесь с главными достопримечательностями Петербурга и прогуляетесь по дворцам и паркам, а по желанию даже сможете прокатиться по каналам, подняться на крыши и посмотреть на развод мостов.', 'img/altay.jpg');
